...
import { Attachment, SendMailOptions } from './interfaces';
...
export class EmailService {
    ...
    private async sendEmailWithFileLogs(to: string | string[]): Promise<boolean> {
        const subject = 'Logs del servidor';
        const html = `
            <h1>Logs del servidor</h1>
            <p>Se adjunta los logs del servidor</p>
        `;
